export const TRACK_LENGTH = 5891; // meters

export const SVG_WAYPOINTS = [
  { dist: 0,    x: 60,  y: 290 },
  { dist: 350,  x: 95,  y: 291 },
...
// Catmull-Rom -> smooth interpolated point for a given distance
...
export function getTrackPosition(distance) {
...
// Generates one smooth closed SVG path string through all waypoints
export function generateSmoothTrackPath() {
  const pts = SVG_WAYPOINTS.slice(0, -1);
  const n = pts.length;
